"""
Business: API для управления отзывами - создание, получение, редактирование, удаление, статистика
    ...
    try:
        if method == 'GET':
            ...
            return {
                ...
                'isBase64Encoded': False,
                'body': json.dumps({'review': dict(updated_review)}, default=str)
            }
            ...
            return {
                ...
                'isBase64Encoded': False,
                'body': json.dumps({'message': 'Отзыв удалён'})
            }
